...
QT_MOC_LITERAL(1, 16, 14), // "setAudioVolume"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 6) // "volume"

    },
    "soundController\0setAudioVolume\0\0volume"
};
...
void soundController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<soundController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setAudioVolume((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
